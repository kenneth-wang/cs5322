...
-- LBAC_DBA:
--      GRANT EXECUTE ON SA_USER_ADMIN TO HR_1;
--      GRANT SELECT ON DBA_SA_USER_LEVELS TO HR_1;
--      GRANT SELECT ON DBA_SA_USER_COMPARTMENTS TO HR_1;
--      GRANT SELECT ON DBA_SA_USER_GROUPS TO HR_1;
--      GRANT SELECT ON DBA_SA_USER_PRIVS TO HR_1;
--      GRANT INVENTORY_OLS_POL_DBA TO HR_1;
--      SELECT * FROM DBA_ROLE_PRIVS WHERE GRANTEE='HR_1';
--
-- 2. Create new user COMM_5
-- SYSTEM:
--      CREATE USER COMM_5 IDENTIFIED BY securepassword DEFAULT TABLESPACE PROJECT2;
--      GRANT CONNECT TO COMM_5;
--      GRANT SELECT,INSERT,UPDATE,DELETE ON INVENTORY.ITEM TO COMM_5;
--
-- X. Reset demo
-- SYSTEM:
--      DROP USER COMM_5 CASCADE;
